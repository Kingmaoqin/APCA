...
from apca.attack_families import COMPRESSION, INFLATION  # noqa: E402
from apca.common import paths  # noqa: E402
from apca.common.io_utils import (  # noqa: E402
    git_commit,
    read_jsonl,
    sha256_file,
    write_json,
...
def freeze(split: Split, manifest_extra: Optional[dict] = None) -> dict[str, Any]:
    ...
    from apca.common.io_utils import write_atomic
...
def main() -> int:
    ...
    include_ts = os.environ.get("R9_INCLUDE_TS", "0") != "0"
    ...
    ts_tasks = []
    if include_ts:
        from apca.adapters.toolsandbox_adapter import ToolSandboxAdapter
