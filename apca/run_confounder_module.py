...
from apca.build_splits import load_registry  # noqa: E402
from apca.common import paths  # noqa: E402
from apca.common.adapters_factory import build_adapters  # noqa: E402
from apca.common.backends import wire_attack_backends  # noqa: E402
from apca.common.io_utils import read_json, write_json  # noqa: E402
from apca.common.llm_client import load_endpoints  # noqa: E402
from apca.common.results_sink import ResultsSink, write_accounting  # noqa: E402
from apca.attacker import HookConfig, build_hook  # noqa: E402
from apca.extract_metrics import extract  # noqa: E402
...
def run(models, repeats, sink, *, limit_tasks=None, live_attacker=True):
    ...
    from apca.targeted_selector import SelectorPriors
    priors = {}
    ...
    from apca.run_confirmatory import _models_for
...
def primary_metric_from_dict(rec: dict, family: str) -> float:
    from apca.reference_metrics import ref_primary
