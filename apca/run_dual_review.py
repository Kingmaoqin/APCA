...
from apca.common.backends import make_text_backend  # noqa: E402
from apca.common.io_utils import read_json, read_jsonl, write_json  # noqa: E402
from apca.common.llm_client import load_endpoints  # noqa: E402
from apca.reference_metrics import ref_primary  # noqa: E402
...
def pre_run_review(reviewer_a, reviewer_b, *, n_candidates: int = 400, seed: int = 20260722) -> dict:
    ...
    """
    from apca.attack_families import TARGET_DIRECTION, library_signature
    from apca.candidate_generator import InteractionState, generate
    from apca.common.io_utils import sha256_obj
    from apca.constraint_filter import dual_review
