...
from apca.canonical_message_cache import CanonicalMessageCache
from apca.common.io_utils import sha256_text
...
def _ok_reviewer(_s, _u):
    import json
    from apca.constraint_filter import REVIEW_FLAGS
